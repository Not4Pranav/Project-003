...
//
// Rules:
// 1. Commands/handlers: throw EmixFGError (via createError) or let errors propagate;
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new EmixFGError(message, type, userMessage, normalizedContext);
}
